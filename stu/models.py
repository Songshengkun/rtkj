...
class StudentInfo(models.Model):
	...
	class_begin_date = models.DateField(default="2019-09-01", verbose_name="开班时间",null=True, blank=True)
	...
	native_palce = models.CharField(max_length=30, verbose_name="籍贯", null=True, blank=True)
